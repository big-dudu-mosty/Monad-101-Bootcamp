...
contract UpgradeFarmGame is Script {
    ...
    function run() external {
        ...
        console.log("Upgrading FarmGame contract with seed purchasing...");
        ...
        FarmGame newFarmGame = new FarmGame(
            SEED_NFT,
            LAND_NFT,
            SHOP,
            KINDNESS_TOKEN
        ...
        console.log("New FarmGame deployed at:", address(newFarmGame));
        ...
        console.log("New FarmGame Address:", address(newFarmGame));
        console.log("Block Number:", block.number);
        console.log("Deployer:", deployer);
        console.log("\nNOTE: Transfer ownership from old to new FarmGame manually!");
    }
}